...
{
    private DataAccess _remote_dataAdapter = null;
    ...
    public void Load_Product(Product p)
    {
        ...
        _remote_dataAdapter = Application.getInstance().getDataAdapter();
        this.setProduct(p);
        if(p == null)
        {
        ...
        ArrayList<Shipper> shipperList = _remote_dataAdapter.GetAllShippers();
        ...
        _shipperMethod = _remote_dataAdapter.GetShipperMethodByShipperIDAndMethod(_shipper.getShipperID(), smethod);
...
//       int id = _product.getProductID();
        ...
        int newOrderID = _remote_dataAdapter.GetNextOrderID();
        ...
        try
        {
            _order.setShippingAddressID(_remote_dataAdapter.GetShippingContactInfoByUser(currentUserID).getContactInfoID());
        }
        ...
        line.setOrderDetailsID(_remote_dataAdapter.GetNextOrdersDetailID());
        ...
        _remote_dataAdapter.saveProduct(_product); // and store this product back right away!!!
        _order.setTotalAmount(total);
