...
public class Product
{
    ...
    private BufferedImage _productImage;


    private BufferedImage _productDetailImage;
    ...
    public BufferedImage get_productDetailImage() {
        return _productDetailImage;
    }
    public void set_productDetailImage(BufferedImage _productDetailImage) {
        this._productDetailImage = _productDetailImage;
    }
