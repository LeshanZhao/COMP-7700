public class WebSellerLoginView {
    public static String getHTMLString_ForSellerLoginRequest(WebDataAdapter sqlDataAdaptor) {
        ...
        response += "</br>The page for seller is under construction.</br>" +
